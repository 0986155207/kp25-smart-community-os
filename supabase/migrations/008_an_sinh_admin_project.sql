-- ============================================================
-- KP25 — Module An sinh Xã hội số
-- Chạy file này tại: https://supabase.com/dashboard/project/pnyjrneqxqckclxehaqv/sql/new
-- ============================================================
...
-- ── RLS (allow all cho authenticated — admin app) ─────────────
...
-- ── AUTO-IMPORT: Người cao tuổi từ nhan_khau ─────────────────
-- Import toàn bộ nhân khẩu >= 60 tuổi vào module quản lý NCT
...
-- Kiểm tra kết quả
SELECT
  'Tổng NCT đã import' AS thong_ke,
  COUNT(*) AS so_luong,
  MIN(ngay_sinh) AS nguoi_lon_nhat,
  MAX(ngay_sinh) AS nguoi_nho_nhat
FROM nguoi_cao_tuoi
