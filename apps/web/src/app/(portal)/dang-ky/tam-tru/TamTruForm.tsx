...
// ─── Component ───────────────────────────────────────────────────
export interface ThongTinCongAn {
  congAnTen: string | null
  congAnSdt: string | null
}

export default function TamTruForm({ congAn }: { congAn: ThongTinCongAn }) {
          ...
          {congAn.congAnTen && (
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="font-bold text-blue-900">{congAn.congAnTen}</p>
                <p className="text-xs text-blue-600">{KHU_PHO.ten} · {KHU_PHO.phuong} · Xét duyệt: 1–5 ngày làm việc</p>
              </div>
              {congAn.congAnSdt && (
                <a
                  href={`tel:${congAn.congAnSdt}`}
                ...
                >
                  ...
                  <span className="text-[11px] font-bold">{congAn.congAnSdt}</span>
                </a>
              )}
            </div>
          )}
