        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <input name="dia_chi_day" className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder={`63/22 Đường số 1, ${KHU_PHO.ten}`} />
            </div>
            <div className="col-span-2">
