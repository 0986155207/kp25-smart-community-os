...
function noiDungSms(link: string): string {
  return `${KHU_PHO.ma} Long Truong: Cap nhat thong tin ho dan tai ${link} - chi 2 phut, mien phi.`
}
...
-- Ban quản lý ${KHU_PHO.ten}, Phường Long Trường`
}
