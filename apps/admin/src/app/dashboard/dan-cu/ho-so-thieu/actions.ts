...
// ════════════════════════════════════════════════════════════
//  ĐỊNH NGHĨA TRƯỜNG & TRỌNG SỐ ĐỘ HOÀN THIỆN
// ════════════════════════════════════════════════════════════
// Mỗi trường có nhãn + nhóm. Độ hoàn thiện = % trường đã điền.
...
function tinhHoanThien(nk: Record<string, unknown>): {
  phanTram: number
  thieu: string[]   // danh sách key còn thiếu
} {
  const thieu: string[] = []
